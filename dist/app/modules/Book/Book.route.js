...
router.get('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), Book_controller_1.BookController.getSingleDataById);
router.get('/:categoryId/category', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), Book_controller_1.BookController.getSingleByCategoryDataById);
